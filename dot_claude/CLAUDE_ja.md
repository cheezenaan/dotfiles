...
- 調査初期段階で、問題が発生している技術層を正確に特定すること
- 正常動作している類似機能との比較分析を並列実行すること
- システム構成調査では、アクセス制御階層の全レイヤーを体系的に確認すること

#### IMPORTANT: 常に意識すること
- 複数システムが連携する環境では、依存関係の上流から下流への影響を意識すること
- ユーザーの技術的指摘を重要な手がかりとして、調査に活用すること
- 最初のアプローチで解決できなかった場合、その理由やアプローチを振り返り、調査プロセス自体を改善すること
- トラブルシューティング解決後は、同種の問題を予防するための体系的チェックリストを提案すること
